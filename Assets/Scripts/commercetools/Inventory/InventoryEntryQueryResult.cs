...
namespace myCT.Inventory
{
    ...
    public class InventoryEntryQueryResult : PagedQueryResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:myCT.Inventory.InventoryEntryQueryResult"/> class.
        /// </summary>
        public InventoryEntryQueryResult() : base() {}
