...
namespace myCT.Carts.UpdateActions
{
    ...
    public class SetCustomShippingMethodAction : UpdateAction
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:myCT.Carts.UpdateActions.SetCustomShippingMethodAction"/> class.
        /// </summary>
        public SetCustomShippingMethodAction()
        {
            this.Action = "setCustomShippinhMethod";
        }
