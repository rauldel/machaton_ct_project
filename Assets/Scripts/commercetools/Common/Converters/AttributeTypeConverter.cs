    ...
    public class AttributeTypeConverter : JsonConverter
    {
		...
		public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
            ...
            switch ((string)jObject.GetValue("name"))
            {
                ...
                case "reference":
                    myCT.ProductTypes.ReferenceType myReferenceType = new myCT.ProductTypes.ReferenceType();
		...
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
		{
            ...
            else if (value is myCT.ProductTypes.ReferenceType)
            {
                JObject jObject = new JObject();
                jObject.Add(new JProperty("name", "reference"));
                myCT.ProductTypes.ReferenceType myReferenceType = (myCT.ProductTypes.ReferenceType)value;
