...
namespace myCT.Common
{
    ...
    public class Token
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:myCT.Common.Token"/> class.
        /// </summary>
        public Token() {}
        ...
        /// <summary>
        /// Returns a <see cref="T:System.String"/> that represents the current <see cref="T:myCT.Common.Token"/>.
        /// </summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current <see cref="T:myCT.Common.Token"/>.</returns>
