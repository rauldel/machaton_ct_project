...
namespace ctLite.Messages
{
    ...
    public class CustomLineItemStateTransitionMessage : Message
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:ctLite.Messages.CustomLineItemStateTransitionMessage"/> class.
        /// </summary>
        public CustomLineItemStateTransitionMessage() : base() {}
