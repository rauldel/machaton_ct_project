...
namespace ctLite.Messages
{
    ...
    public class PaymentTransactionStateChangedMessage : Message
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:ctLite.Messages.PaymentTransactionStateChangedMessage"/> class.
        /// </summary>
        public PaymentTransactionStateChangedMessage() : base() {}
